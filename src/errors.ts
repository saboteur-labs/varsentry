...
export const ERROR_CODES = {
    ...
    VALIDATION_INVALID_URL_VALUE: "VALIDATION_INVALID_URL_VALUE",
    VALIDATION_INVALID_ENUM_VALUE: "VALIDATION_INVALID_ENUM_VALUE",
    VALIDATION_INVALID_SEMVER_VALUE: "VALIDATION_INVALID_SEMVER_VALUE",
...
export const ERROR_MESSAGES = {
    ...
    [ERROR_CODES.VALIDATION_INVALID_URL_VALUE]: "Invalid URL value",
    [ERROR_CODES.VALIDATION_INVALID_ENUM_VALUE]: "Invalid enum value",
    [ERROR_CODES.VALIDATION_INVALID_SEMVER_VALUE]: "Invalid semver value",
...
export function setTypeErrorCode(type: VarType): ErrorCode {
    switch (type) {
        ...
        case "url":
            return "VALIDATION_INVALID_URL_VALUE";
        case "enum":
            return "VALIDATION_INVALID_ENUM_VALUE";
        case "semver":
            return "VALIDATION_INVALID_SEMVER_VALUE";
    }
}
